...
public static class SpiralSphereMesh {
    ...
    // params
    // Cache generated by other ShapeMeshGenerator
    ...
    // find in cache
    private static bool find_sphere_in_cache(uint number_of_points, out SphereMesh retSphere) {
        retSphere = null;
    ...
    private static SphereMesh construct_unit_sphere(uint number_of_points) {
